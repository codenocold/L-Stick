...
#define LIS3DH_I2_ACT_ON_INT2_ENABLE                   0x08
#define LIS3DH_I2_ACT_ON_INT2_DISABLE                  0x00
...
#define LIS3DH_ReadReg  ACCEL_read_reg
#define LIS3DH_WriteReg ACCEL_write_reg
