...
电源锁定指的是我们通过按键按下，系统上电开机后我们通过程序控制nRF52832 IO 口拉高来控制供电开关mos管持续导通，这样当我们松开按键的时候系统依然正常供电工作，我们的硬件电路中除了通过nRF52832 IO 口来锁定电源之外还可以通过插入充电器来锁定电源即当我们接入充电器时电源已锁定。

### 工程建立

我们把SDK/examples/L-Stick/RTT文件夹复制一份并重命名位Power作为我们本节的工程文件夹。
