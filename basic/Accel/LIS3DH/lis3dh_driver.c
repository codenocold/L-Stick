...
* example        : LIS3DH_SetInt2Pin(LIS3DH_CLICK_ON_PIN_INT2_ENABLE/DISABLE | LIS3DH_I2_INT1_ON_PIN_INT2_ENABLE/DISABLE |               
                   LIS3DH_I2_INT2_ON_PIN_INT2_ENABLE/DISABLE | LIS3DH_I2_BOOT_ON_INT2_ENABLE/DISABLE | LIS3DH_I2_ACT_ON_INT2_ENABLE/DISABLE                 
                   LIS3DH_INT_ACTIVE_HIGH/LOW)
...
/*******************************************************************************
* Function Name  : LIS3DH_SetActivThreshold
* Description    : Sets active/inactive Threshold
...
status_t LIS3DH_SetActivThreshold(u8_t ths)
{
  ...
  if( !LIS3DH_WriteReg(LIS3DH_ACT_THS, ths) )
    return MEMS_ERROR;    
...
/*******************************************************************************
* Function Name  : LIS3DH_SetActivDuration
* Description    : Sets active/inactive detect Duration
* Input          : Duration value
* Output         : None
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
...
{
  if( !LIS3DH_WriteReg(LIS3DH_ACT_DUR, dur) )
    return MEMS_ERROR;    
